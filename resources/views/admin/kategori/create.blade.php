                ...
                <div class="form-row">
                    <div class="col-md-12">
                        <div class="position-relative form-group">
                            ...
                            <input name="nama_kategori" id="nama_kategori" placeholder="Masukkan Tingkat Sekolah" type="text" class="form-control @error('nama_kategori') is-invalid @enderror" value="{{ old('nama_kategori') }}">
                            @error('nama_kategori')
