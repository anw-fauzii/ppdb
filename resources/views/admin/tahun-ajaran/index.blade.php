                            ...
                            <tr>
                                ...
                                <td class="d-flex">
                                    @if ($item->status == FALSE)
                                        <a href="{{ route('tahun-ajaran.show', $item->id) }}" class="btn btn-sm btn-danger mx-1"><i class="pe-7s-unlock" style="font-size: 1rem;"></i></a>
                                    @else
                                        <a href="{{ route('tahun-ajaran.show', $item->id) }}" class="btn btn-sm btn-success mx-1"><i class="pe-7s-lock" style="font-size: 1rem;"></i></a>
                                    @endif
